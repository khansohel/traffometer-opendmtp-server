...
/**
 * This class defines the client errors.  The type of errors include protocol/
...
// ----------------------------------------------------------------------------
    ...
    {
        switch (errCode) {
            case ERROR_PACKET_HEADER:           return "Invalid packet header";
            case ERROR_PACKET_TYPE:             return "Invalid packet type";
            case ERROR_PACKET_LENGTH:           return "Invalid packet length";
            case ERROR_PACKET_ENCODING:         return "Unsupported packet encoding";
            case ERROR_PACKET_PAYLOAD:          return "Invalid packet payload";
            case ERROR_PACKET_CHECKSUM:         return "Invalid checksum";
            case ERROR_PACKET_ACK:              return "Invalid ACL sequence";
            case ERROR_PROTOCOL_ERROR:          return "Protocol error";
            case ERROR_PROPERTY_READ_ONLY:      return "Property is read-only";
            case ERROR_PROPERTY_WRITE_ONLY:     return "Property is write-only";
            case ERROR_PROPERTY_INVALID_ID:     return "Invalid/Unrecognized property key";
            case ERROR_PROPERTY_INVALID_VALUE:  return "Invalid propery value";
            case ERROR_PROPERTY_UNKNOWN_ERROR:  return "Unknown property error";
            case ERROR_COMMAND_INVALID:         return "Invalid/Unsupported command";
            case ERROR_COMMAND_ERROR:           return "Command error";
            case ERROR_UPLOAD_TYPE:             return "Invalid upload type";
            case ERROR_UPLOAD_LENGTH:           return "Invalid upload length";
            case ERROR_UPLOAD_OFFSET_OVERLAP:   return "Upload offset overlap";
            case ERROR_UPLOAD_OFFSET_GAP:       return "Upload offset gap";
            case ERROR_UPLOAD_OFFSET_OVERFLOW:  return "Upload offset overflow";
            case ERROR_UPLOAD_FILE_NAME:        return "Invalid uploaded filename";
            case ERROR_UPLOAD_CHECKSUM:         return "Invalid uploaded checksum";
            case ERROR_UPLOAD_SAVE:             return "Unable to save uploaded file";
            case ERROR_GPS_EXPIRED:             return "GPS fix expired";
            case ERROR_GPS_FAILURE:             return "GPS failure";
        }
