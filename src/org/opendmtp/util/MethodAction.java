 ...
 * FIXME: not very good
 * 
 * some sort of reflection api helper lib
 * 
...
public class MethodAction implements ActionListener, Runnable {
  ...
  public MethodAction(Object targ, String methName) throws NoSuchMethodException,
      ClassNotFoundException {
    this(targ, methName, null, null);
  }

  public MethodAction(Object targ, String methName, Class argClass[]) throws NoSuchMethodException,
      ClassNotFoundException {
  ...
  public MethodAction(Object targ, String methName, Class argClass[], Object args[])
    ...
    this.targetClass = (this.target instanceof Class) ? (Class) this.target : this.target
        .getClass();
  ...
  public static String InvokeGetter(Object targ, String fieldName) throws NoSuchMethodException,
