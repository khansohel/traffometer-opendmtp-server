    ...
    extends AbstractClientPacketHandler
{
    ...
    private void loadUniqueID(byte id[])
    ...
    private void loadAccountId(String acctName)
        throws PacketParseException
    {
    ...
    private void _setAccountId(AccountID acctId)
        throws PacketParseException
    {
    ...
    private void loadDeviceId(String devName)
        throws PacketParseException
    {
    ...
    private void _setDeviceId(DeviceID devId)
        throws PacketParseException
    {
    ...
    private Packet[] _handlePacket(Packet packet)
        throws PacketParseException
    {
